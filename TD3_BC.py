...
class Actor(nn.Module):
    def __init__(self, encoder, action_dim, hidden_dim, max_action):
...
class Critic(nn.Module):
    def __init__(self, encoder, action_dim, hidden_dim):
        ...
        self.encoder = encoder
        # Q1 architecture
        self.l1 = nn.Linear(self.encoder.out_dim + action_dim, hidden_dim)
        self.l2 = nn.Linear(hidden_dim, hidden_dim)
        self.l3 = nn.Linear(hidden_dim, 1)

        # Q2 architecture
        self.l4 = nn.Linear(self.encoder.out_dim + action_dim, hidden_dim)
...
class TD3_BC(object):
    ...
    def train(self, replay_buffer, writer, step, batch_size=256):
        ...
        state, action, reward, next_state, not_done = replay_buffer.sample()
        ...
        writer.add_scalar(f'train/critic_loss', critic_loss, step)
